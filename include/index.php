<?php include("ajax/includes/_conection.php"); ?>
<?php require_once("ajax/includes/xajax/xajax.inc.php"); ?>
<?php
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  <head>
    <title>Ajax</title>
    <link  href="ajax/estilos/estilos.css" type="text/css" rel="stylesheet" />

    <?php $xajax->printJavascript('ajax/includes/xajax/','',''); ?>
    <script type="text/javascript" src="ajax/script/autosuggestcontroller.js"></script>
    <script type="text/javascript" src="ajax/script/statessuggestionprovider.js"></script>
	<script type="text/javascript" src="ajax/script/funcoes_uteis.js"></script>
